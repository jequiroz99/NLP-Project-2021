'''
This Word2Vec Model trains on all
of the songs of a given artist, that
way it has a vector for every artist.
For testing, it is also given all of the songs of an
artist, and predicts the artist's genre!
'''
...
if __name__ == "__main__":
    ...
    #embeds = Word2Vec.load("word2vec.model")
