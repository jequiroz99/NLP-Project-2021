...
class Dataset :
    ...
    def __init__(self) :
        ...
        'katy perry', 'glee', 'madonna', 'maroon 5', 'selena gomez', 
        'nick jonas', 'ellie goulding', 'mariah carey', 'jackson 5', 
        'michael jackson', 'adele', 'justin bieber', 'lady gaga']
        ...
        self.testingData['pop'] = ['george michael', 'kesha', 'britney spears', 
        'rihanna', 'cher']
    ...
    def getDataSet(self, tag) :
        ...
        for genre in ['rock', 'pop', 'hip hop'] :
            ...
            for artist in artists :
                ...
                # store song's lyrics #
                for song in reader :
                  dataset.append((genre, artist, song[1]))
